...
\section{Two Beam Acceleration (TBA)}
\begin{frame}
...
\Wider[4em]{
	...
	\centering
	\includegraphics[width=0.7\textwidth]{../../tex/images/THPAB155f2}
}
\end{frame}
...
\includegraphics[width=0.45\textwidth]{../../tex/images/THPAB155f1}%
\includegraphics[width=0.45\linewidth]{/home/nicole/Documents/presentations/ipac2018/opt-ipac18/THPMF049f3}
\begin{itemize}
	\item Validation of model based results
	\item In total, 2,492 simulations for BOBYQA.
	\item xx,xxx for GA
\end{itemize}
\end{frame}
...
\includegraphics[width=\textwidth]{{/home/nicole/Documents/awa-tba/pareto_stat_plots/safehold/xyrms-optLinac-40nC_KQ3=3.2_KQ5=-1.25_KQ6=-0.25_KQ7=0_KQ8=0}.pdf}	
\end{minipage}
\begin{minipage}{0.45\textwidth}
...
\includegraphics[width=\textwidth]{{/home/nicole/Documents/awa-tba/pareto_stat_plots/safehold/xyrms-csr_fields}.pdf}		
\end{minipage}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\includegraphics[width=0.3\textwidth]{{/home/nicole/Documents/awa-tba/pareto_stat_plots/safehold/KQ3=3.2/xyrms-optLinac-40nC_KQ3=3.2_IM=220}.pdf}%	
%\includegraphics[width=0.3\textwidth]{{/home/nicole/Documents/awa-tba/pareto_stat_plots/safehold/KQ3=3.2/xyrms-optLinac-40nC_KQ3=3.2_IM=225}.pdf}%	
%\includegraphics[width=0.3\textwidth]{{/home/nicole/Documents/awa-tba/pareto_stat_plots/safehold/KQ3=3.2/xyrms-optLinac-40nC_KQ3=3.2_IM=230}.pdf} \\%
%\includegraphics[width=0.3\textwidth]{{/home/nicole/Documents/awa-tba/pareto_stat_plots/safehold/KQ3=3.2/xy-max-min-optLinac-40nC_KQ3=3.2_IM=220}.pdf}%	
%\includegraphics[width=0.3\textwidth]{{/home/nicole/Documents/awa-tba/pareto_stat_plots/safehold/KQ3=3.2/xy-max-min-optLinac-40nC_KQ3=3.2_IM=225}.pdf}%	
%\includegraphics[width=0.3\textwidth]{{/home/nicole/Documents/awa-tba/pareto_stat_plots/safehold/KQ3=3.2/xy-max-min-optLinac-40nC_KQ3=3.2_IM=230}.pdf}%
%
\end{frame}
