...
\def \lsixright {6.0}
        \centering
        \begin{center}
                \begin{tikzpicture}[scale=0.7]%,use optics
                %Gun drawings
                \draw[fill=orange, very thick, rounded corners =0.1cm] (\gunleft,0.5)rectangle (\gunright,1.5) node[pos=.5, white] {\textbf{Gun}} ;
                ...
                %Quad drawings
                \draw[fill=black!60!green] (7.8, 1.0) ellipse (0.2cm and 0.9cm);
                \draw[fill=black!60!green] (8.3, 1.0) ellipse (0.2cm and 0.9cm);
                \draw[fill=black!60!green] (8.8, 1.0) ellipse (0.2cm and 0.9cm);
                \draw[fill=black!60!green] (9.3, 1.0) ellipse (0.2cm and 0.9cm);

				%Kicker 
				\draw[fill=orange, ultra thick, rounded corners =0.1cm] (\lsixright+4.2,0.5)rectangle ({\lsixright+0.84+5},1.5) node[pos=.5, white] {$Kicker$};
				
                \draw[very thick] (\lsixright+5.9,1.0) -- (14,-0.5);
                
                \node[] at (\lsixright+6.5,-1.0) {Septum};
                \draw[fill=black!60!green, ultra thick, rounded corners =0.1cm] (\lsixright+7,0.5)rectangle ({\lsixright+8},-0.5) node[pos=.5, white] {$Kicker$};
