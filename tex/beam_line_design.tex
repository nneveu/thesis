...
\nrnote{short discussion of the issues, what are you trying to achieve, where are apetures tight.
...
\nrnote{conclude, opt results shows beamline is viable based on intro criteria}
