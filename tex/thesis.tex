...
\Chapter{Hardware Improvements and Installation Tests}
...
When TBA experiments are run, both beam lines are operated simultaneous. This is accomplished by
...
\end{figure}
Ideally, each pulse generated by the multisplitter would be exactly identical. This 
would ensure a uniform RF power generated in the PETS, as the power depends on both the 
charge and shape of the bunch. However, as not experiment is perfect, 
...
Measurements of the UV splitters were done to determine what the T/R ratio was for 
each splitter. The measurements took place in the laser room, close to the source of the laser.
Several configurations were tested. Whether the laser pulse hit the front or back of the optic
had no measurable effect on the measurements. Polarization did have a significant effect on
the results, which led to more careful observation of this in the future.
The following plot shows the splitters were performing at about 45/55 ratio, meaning
pulses that were transmitted more than one time could have significantly lower intensities than 
other bunches. 
\begin{figure}[h]
	\begin{center}
