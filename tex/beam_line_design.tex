...
With the kicker and septum parameters defined by the constraints dicussed above, 
the optics and aperture limits further down stream were considered.
...
For transmission, an aperture of \SI{17.6}{mm} exist at the PETS.
...
From many sources~\cite{brown,Wiedemann} the building blocks of any 
beam line can be defined. These typically include drift, quadrupoles, and dipoles.
Using these common building blocks a check of the transport matrix for the 
first four quadrupoles before the kicker was done,  see Figure~\ref{fig:quads}.
\begin{figure}
	\centering
	...
	\label{fig:p2p}
\end{figure}
This established the beam size could be maintained near the kicker during transport.  
