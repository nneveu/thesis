...
a PIC \nrnote{(assuming PIC is defined in simulations cp?)} simulation was done to estimate the beam 
...
\nrnote{not sure if I should address this}}
	\label{fig:beamtraj}
\end{figure}
\nrnote{Cutting CST all together because they are only impedance calculations}
...
The machine was operated in TBA-like conditions based on simulations 
done to optimize for future TBA runs.
The charge was \SI{30}{nC}, buck focusing was at \SI{550}{A}, matching solenoid was at \SI{200}{A}, 
...
The centroid of the beam was calculated for several voltages, and a linear fit was performed.
The R value for the fit in Figure \ref{fig:linear} is 0.99704. This suggest the beam offset 
...
\end{figure}
\nrnote{probably need more in this section.}
