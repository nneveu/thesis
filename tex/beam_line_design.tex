...
\begin{figure}
	%\includegraphics[width=0.5\textwidth]{images/xy-max-min-optLinac-40nC_IM184}
...
quadrupole strengths were chosen for 5 and 6 and the rest of the beam line to the PETS location 
was simulated.
\begin{figure}
