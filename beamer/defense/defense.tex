...
\begin{frame}
	...
	\centering
	\includegraphics[width=0.45\textwidth]{../../tex/images/kicker1}\hspace{1em}%
	\vspace{-2em}
	\includegraphics[width=0.5\textwidth]{../../tex/images/TDR_AWA_kicker}
\end{frame}
...
\begin{itemize}
	...
	\item A layout was designed for fully staged TBA
...
\includegraphics[width=0.3\textwidth]{../../beamer/long_talk/DOE_logo_color_cmyk-eps-converted-to}
\end{frame}
