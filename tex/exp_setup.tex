...
The beam line located on the right side of Figure~\ref{fig:bunker} is called the
...
to be roughly the same intensity. This is shown in Figure~\ref{fig:origtrain}. With the same 
...
Note the units in the table are picoseconds and the units in Figure~\ref{sims} are millimeters.
