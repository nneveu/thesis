...
Initially OPAL-T was benchmarked against the more commonly used particle tracking codes, ASTRA and GPT.  This ensured correct use of the code, and reliability of \mbox{OPAL-T}.  Two collective effects of particular interest to the AWA were included in the investigation: 
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.95\textwidth]{images/gun_EM_fields}\caption{Electric and magnetic fields seen by the beam on axis in the gun.  \lsnote{Specify the Z distance to end of gun in figure caption}}\label{fig:gunfields}
	\end{center}
\end{figure}
...
mono-energetic bunches with a Gaussian  energy distribution with  zero  initial \lsnote{transverse} emittance  
...
are  shown  in  Figure  4.  \lsnote{{\it missing figure}} As  expected,  the  results  between  
