...
\begin{figure*}[h]
	\begin{center}		
		...
		\node[] at (20,-1) {Heliax to 6Ghz scope or power meter};
...
\begin{figure*}[h]
	\begin{center}		
		...
		\end{circuitikz}
	\end{center} 
	\caption{Experimental set up when calibrating cables connected to drive gun and 6 GHz scope.}
