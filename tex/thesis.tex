...
\Chapter{Hardware Improvements and Installation}
...
used for TBA drive trains, and ideally, each pulse generated by the multisplitter would be exactly identical.
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale=0.4]{images/multisplitter}\caption{UV Multisplitter}
	\end{center}
	\label{fig:multisplit}
\end{figure}
While ideal is unattainable, improving the laser pulse train intensity distribution helps
...
the background, ASC. This quantity is known to drift with temperature and operating time. 
