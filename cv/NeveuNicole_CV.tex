...
\cventry{Lemont, IL}{Argonne National Laboratory}{Graduate Student, Argonne Wakefield Accelerator}{2013--Present}{}{Design, optimization, and simulation of rf photoinjectors (witness and drive at AWA) using OPAL-T.\newline
Experimental validation of results.Completed and ongoing work includes:
\begin{itemize}%
\item Simulation:
  \begin{itemize}%
  \item TBA drive beam line design  
  \item High charge linac optimization
  \item Optical Transistion Radiation (OTR) on witness beam line
...
%\bibliographymisc{refproc}                   % 'publications' is the name of a BibTeX file
...
\cventry{Beijing, China}{TA, Technical English}{Tsinghua University}{June-July 2015--2017}{}{}%}
