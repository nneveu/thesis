...
Next the energy measurment was analyized to determine the beam energy. 
THe method described in Chapter \ref{chp:exp}. \nrnote{add in energy calc}
...
the large discrepancy in the horizontal and vertical beam size
can not be attributed to the kicker alone.
...
While  the kicker and septum parameters were defined by the constraints dicussed above, 
...
For transmission, an aperture of \SI{17.6}{mm} exists at the PETS.
...
would allow transport through the kicker (see Figure~\ref{fig:quads}),
\iftrue
\begin{figure}
	\centering
