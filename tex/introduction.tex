...
by taking the Fourier transform of the Gaussian charge distribution \cite{PETSeq}: 
\begin{equation}
...
\nrnote{changed $v_ga$ to $v_a$, need to double check this is done everywhere}
\begin{equation}
E_{a}^{2}=\frac{P_{t\,}\omega}{v_{a}}\frac{R}{Q_a}
