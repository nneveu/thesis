...
\end{equation}
\lsnote{{\it That equation result is wrong unless I am missing something.  
		If you go through a splitter, you have about half the original intensity.  
		Four splitters would give about 6 percent not 41 percent.  Same comment for equation below.}} 
...
therefore a lower pulse intensity is expected in experimental measurements. The path of laser pulse one and
...
power meter. Normally a load is placed at port two when a power meter is \lsnote{not} connected. 
...
In order to measure the bunch length, we performed an auto-correlation scan
