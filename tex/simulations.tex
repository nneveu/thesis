...
Higher charge also means higher emittances which can reach the \SI{100}{\u m} if not careful.
...
out due to the recent measurment discussed in Chapter~\ref{chp:exp}. 
...
\begin{table}[h]
	...
	\begin{tabular}{rccc}
		\toprule
		\toprule
		\textbf{Charge} & \textbf{Bunch Dur. (RMS)} \textbf{Bunch Length (RMS)} & \textbf{Laser spot size}  \\
		\midrule
