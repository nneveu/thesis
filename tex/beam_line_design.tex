...
While  the  er and septum parameters were defined by the constraints discussed above, 
...
\begin{table}%[h!]
	...
	\end{center}
\end{table}
In other words, the first quadrupole between the septum and kicker, see Figure~\ref{fig:full-staging}.
...
The results in Figure~\ref{fig:optresults} are promising, they indicate the optics 
...
extreme limits of the magnetic, meaning there is plenty of wiggle room to adjust 
...
\begin{figure}
	...
	\caption{Simulation of the optimized settings in Table~\ref{tab:designopt} with CSR and 3D field maps.
...
and given the solution in 2D, there is plenty of range on the solenoid and quadrupoles to do this.
A scan of the matching solenoid was done to try to reduce the over focusing in the horizontal direction
