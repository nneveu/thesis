...
The is the calculation done for all energy measurements at the AWA.
...
With a fiducial, charge cut, and clean beam images, the beam sizes profiles can be generated.
...
Scans were done at low, \SI{1}{nC}, and high charge, \SI{40}{nC}, see Figure~\ref{label}. 
...
A significant amount of experimental setup and preparation is 
required before the demonstration of fully staged TBA.
Work in the area has begun and continues. 
