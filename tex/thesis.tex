...
\begin{figure*}[h]
	\begin{center}		
		...
		\draw[cyan,very thick] (\delaytworight,\delayvertical) -- (\delaytworight,\delayvertical+1.5);
		\draw[cyan,very thick] (\mycenter,\delayvertical*2) -- (\mycenter,\delayvertical*4);
		...
		\draw[black, very thick] (\delayoneleft, -1) -- (\mycenter, -1);
		...
		\draw[black, very thick] (\mycenter, 3.5+\buffer) -- (\delaytworight, 3.5+\buffer);
		\draw[black, very thick] (\delaytworight, 3.0+\buffer) -- (\delaytworight, 4.0+\buffer);
		\draw[black, very thick] (\mycenter, 4.0+\buffer) -- (\mycenter, 3.0+\buffer);
		\end{tikzpicture}
	\end{center} 
